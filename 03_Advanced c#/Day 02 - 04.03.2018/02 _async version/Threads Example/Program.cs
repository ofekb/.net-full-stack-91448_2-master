    ...
    class Program
    {
        static void Print1(object limit)
        {
            ...
            for (int i = 0; i < num; i++)
            {
                ...
                Thread.Sleep(500); // Delay - milliseconds
            }
        ...
        static void Print2()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Thread.Sleep(500); // Delay to current thread- milliseconds
        ...
        static void Main(string[] args) // The Main Thread
        {
            ...
            /*
             * if IsBackground is true - the thread will be dead when the parent thread is dead
             * if IsBackground is false - the thread will stay alive when the parent thread is done
             */
